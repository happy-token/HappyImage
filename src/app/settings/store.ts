...
function normalizeConfig(config: SettingsConfig): SettingsConfig {
  ...
  return {
    ...
    image_storage: {
      ...
      webdav_root_path: String(imageStorage.webdav_root_path || "happyimage/images"),
    ...
    try {
      const data = await updateSettingsConfig({
        ...
        image_storage: {
          ...
          webdav_root_path: String(config.image_storage?.webdav_root_path || "happyimage/images").trim(),
