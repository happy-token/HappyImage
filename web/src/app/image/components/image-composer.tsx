...
const geminiImageModelLabels: Record<string, string> = {
...
function formatImageModelLabel(model: ImageModel) {
  return geminiImageModelLabels[model] || model;
}
...
export function ImageComposer({
  ...
  const qualityLabel =
    ...
    "自动";
  const ratioLabel =
    imageRatio === "auto" ? "auto" : `${imageRatio}(${imageTier})`;
      ...
      <div style={{ width: "min(920px, 100%)" }}>
        ...
        <div
          className={cn(
            ...
            isDraggingImage &&
              "border-zinc-400 bg-zinc-50 shadow-[0_22px_80px_-44px_rgba(39,39,42,0.36)] dark:border-zinc-500 dark:bg-zinc-900"
          )}
        >
          <div
          ...
          >
            ...
            <div
              className="rounded-b-[24px] border-t border-zinc-100 bg-zinc-50 px-3 pb-3 pt-2 dark:border-zinc-800 dark:bg-[#171717]/95 sm:absolute sm:inset-x-0 sm:bottom-0 sm:rounded-b-[28px] sm:border-t-0 sm:bg-gradient-to-t sm:from-zinc-50 sm:via-zinc-50/96 sm:to-transparent sm:px-5 sm:pb-3 sm:pt-6 sm:dark:from-[#171717] sm:dark:via-[#171717]/95 sm:dark:to-[#171717]/0"
