...
This repository now has a formal monorepo layout:

- `skills/`: standalone baoyu skills.
- `packages/core/`: shared HappyImage runtime.
- `packages/web-ui/`: Hono API + React Web UI.
- `packages/cli/`: `happyimage` CLI.
- `packages/desktop/`: Electron desktop wrapper.
- `screenshots/`: shared preview assets for docs and Web UI.

See [docs/project-structure.md](./docs/project-structure.md) for the full directory contract and artifact policy.
